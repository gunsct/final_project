...
public class GridManager : MonoBehaviour
{
    ...
    void CalculateObstacles()
    {
		...
		nodes = new Shell[numOfColumns, numOfRows];
    ...
    /// </summary>
	public void GetNeighbours(Shell node, ArrayList neighbors)
    {
    ...
    void AssignNeighbour(int row, int column, ArrayList neighbors)
    {
        ...
        {
			Shell nodeToAdd = nodes[row, column];
